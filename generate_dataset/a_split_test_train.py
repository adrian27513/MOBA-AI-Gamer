...
dataset_path = "C:/Users/Adrian/PycharmProjects/LeagueHumanPlayerAI/generate_dataset/output"
...
for i in range(0,len(datasets_train)):
    os.rename(dataset_path+"/images/"+datasets_train[i],
              "C:/Users/Adrian/PycharmProjects/LeagueHumanPlayerAI/data/images/train/"+datasets_train[i])
    os.rename(dataset_path+"/labels/"+datasets_train[i].replace(".jpg",".txt"),
              "C:/Users/Adrian/PycharmProjects/LeagueHumanPlayerAI/data/labels/train/"+datasets_train[i].replace(".jpg",".txt"))
...
for i in range(0,len(datasets_valid)):
    os.rename(dataset_path+"/images/"+datasets_valid[i],
              "C:/Users/Adrian/PycharmProjects/LeagueHumanPlayerAI/data/images/valid/"+datasets_valid[i])
    os.rename(dataset_path+"/labels/"+datasets_valid[i].replace(".jpg",".txt"),
              "C:/Users/Adrian/PycharmProjects/LeagueHumanPlayerAI/data/labels/valid/"+datasets_valid[i].replace(".jpg",".txt"))
